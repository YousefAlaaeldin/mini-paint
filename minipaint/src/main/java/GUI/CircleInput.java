...
public class CircleInput extends JFrame implements Node{
    ...
    public CircleInput(Circle circle, PaintFrame machine) {
        initComponents();
        this.circle = circle;
        parentNode  = null;
    ...
    private void initComponents() {
        ...
        raduis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                raduisActionPerformed(evt);
            }
        });
    ...
    private void raduisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_raduisActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_raduisActionPerformed
